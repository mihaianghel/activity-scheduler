...
public class HelperTest {
   ...
   public void testFormatDurationToMins() {
      assertEquals("60min", Helper.formatDuration(60));
   }

   @Test
   public void testFormatDurationToSprint() {
      assertEquals(Constants.SPRINT, Helper.formatDuration(Constants.SPRINT_DURATION));
   }

   @Test
   public void testFormatDate() {
      assertEquals("12:00 pm", Helper.formatDate(LocalTime.NOON));
   }
